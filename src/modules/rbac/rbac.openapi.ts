...
export function registerRbacOpenApi(): void {
  ...
  openapiRegistry.registerPath({
    ...
    responses: {
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Xóa vai trò thành công" }),
            }),
          },
        },
      },
      403: {
        description:
          "Không thể xóa System Role hoặc vai trò đang có người dùng",
      },
    },
  });
  ...
  openapiRegistry.registerPath({
    ...
    request: {
      params: roleIdParamSchema,
      body: {
        content: { "application/json": { schema: assignPermissionsSchema } },
      },
    },
    responses: {
      200: {
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Đồng bộ quyền cho vai trò thành công" }),
            }),
          },
        },
      },
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Xóa quyền khỏi vai trò thành công" }),
            }),
          },
        },
      },
  ...
  openapiRegistry.registerPath({
    ...
    request: {
      ...
      body: {
        content: { "application/json": { schema: assignUserRoleSchema } },
      },
    },
    responses: {
      200: {
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Gán vai trò cho người dùng thành công" }),
            }),
          },
        },
      },
