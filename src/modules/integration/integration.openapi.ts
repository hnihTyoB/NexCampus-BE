...
export function registerIntegrationOpenApi(): void {
  ...
  openapiRegistry.registerPath({
    ...
    summary:
      "Tạo API Key mới cho hệ thống bên thứ ba (Chỉ hiển thị plaintext 1 lần)",
    security: [{ BearerAuth: [] }],
    request: {
          ...
          "application/json": {
            schema: z.object({
              ...
              message: z.string().openapi({
                example:
                  "API Key được tạo thành công. Hãy lưu key này ngay, nó sẽ không hiển thị lại!",
              }),
              data: z.object({
                id: z.string().uuid(),
                name: z.string(),
                apiKey: z
                  .string()
                  .openapi({ example: "ak_live_a1b2c3d4e5f6..." }),
                prefix: z.string(),
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "API Key đã được xóa thành công" }),
            }),
          },
        },
      },
  ...
  openapiRegistry.registerPath({
    ...
    summary:
      "Đăng ký Webhook endpoint mới (Kèm bí mật HMAC-SHA256 & bảo vệ SSRF)",
    security: [{ BearerAuth: [] }],
    request: {
      body: {
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Webhook đã được xóa thành công" }),
            }),
          },
        },
      },
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Đã gửi test ping webhook vào hàng đợi" }),
            }),
          },
        },
      },
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Đã lập lịch thử lại phân phối Webhook" }),
            }),
          },
        },
      },
        ...
        content: {
          "application/json": {
            schema: z.object({
              ...
              message: z
                .string()
                .openapi({ example: "Job triggered successfully" }),
              data: z.object({
                jobId: z.string(),
                jobType: z.string(),
