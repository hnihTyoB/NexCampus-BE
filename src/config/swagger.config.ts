  ...
  paths: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { type: 'array', items: { $ref: '#/components/schemas/Intern' } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
        },
    ...
    '/task-assignments': {
      get: {
        ...
        parameters: [
          ...
          { in: 'query', name: 'internId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'assignedBy', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'status', schema: { type: 'string', enum: ['TODO', 'IN_PROGRESS', 'REVIEW', 'DONE'] } },
          { $ref: '#/components/parameters/PageParam' },
          { $ref: '#/components/parameters/LimitParam' },
          { in: 'query', name: 'sortBy', schema: { type: 'string', enum: ['assignedAt', 'status'], default: 'assignedAt' } },
          { $ref: '#/components/parameters/OrderParam' },
        ],
        responses: {
          200: {
            description: 'Danh sách phân công',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { type: 'array', items: { $ref: '#/components/schemas/TaskAssignment' } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
        },
      ...
      post: {
        ...
        security: [{ BearerAuth: [] }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateTaskAssignmentBody' } } } },
        responses: {
          201: {
            description: 'Đã giao việc thành công',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/TaskAssignment' } } }] } } },
          },
          400: { description: 'Công việc quá hạn hoặc dữ liệu không hợp lệ', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          409: { description: 'Công việc đã được giao trước đó', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
    },
    '/task-assignments/{id}': {
      get: {
        ...
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        responses: {
          200: { description: 'Thông tin phân công', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/TaskAssignment' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
      ...
      put: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateTaskAssignmentBody' } } } },
        responses: {
          200: { description: 'Đã cập nhật', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/TaskAssignment' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
    ...
    '/task-submissions': {
      get: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [
          { in: 'query', name: 'assignmentId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'reviewStatus', schema: { type: 'string', enum: ['PENDING', 'APPROVED', 'REJECTED'] } },
          { in: 'query', name: 'reviewedBy', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'internId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'taskId', schema: { type: 'string', format: 'uuid' } },
          { $ref: '#/components/parameters/PageParam' },
          { $ref: '#/components/parameters/LimitParam' },
          { in: 'query', name: 'sortBy', schema: { type: 'string', enum: ['submittedAt', 'reviewStatus', 'attempt'], default: 'submittedAt' } },
          { $ref: '#/components/parameters/OrderParam' },
        ],
        responses: {
          200: {
            description: 'Danh sách bài nộp',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { type: 'array', items: { $ref: '#/components/schemas/TaskSubmission' } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
        },
      ...
      post: {
        ...
        security: [{ BearerAuth: [] }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateTaskSubmissionBody' } } } },
        responses: {
          201: {
    ...
    '/task-submissions/{id}': {
      get: {
        ...
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        responses: {
          200: { description: 'Thông tin bài nộp', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/TaskSubmission' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
      ...
      put: {
        tags: ['TaskSubmissions'],
        summary: 'Cập nhật bài nộp / Đánh giá chấm điểm (Intern / Leader / Admin)',
        security: [{ BearerAuth: [] }],
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateTaskSubmissionBody' } } } },
        responses: {
          200: { description: 'Cập nhật thành công', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/TaskSubmission' } } }] } } } },
          400: { description: 'Không thể chỉnh sửa bài nộp đã được duyệt', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
    ...
    '/daily-reports': {
      get: {
        ...
        parameters: [
          { in: 'query', name: 'internId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'createdAtFrom', schema: { type: 'string', format: 'date-time' } },
          { in: 'query', name: 'createdAtTo', schema: { type: 'string', format: 'date-time' } },
          { $ref: '#/components/parameters/PageParam' },
          { $ref: '#/components/parameters/LimitParam' },
          { in: 'query', name: 'sortBy', schema: { type: 'string', enum: ['createdAt', 'internId'], default: 'createdAt' } },
          { $ref: '#/components/parameters/OrderParam' },
        ],
        responses: {
          200: {
            description: 'Danh sách báo cáo',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { type: 'array', items: { $ref: '#/components/schemas/DailyReport' } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
        },
      ...
      post: {
        ...
        security: [{ BearerAuth: [] }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateDailyReportBody' } } } },
        responses: {
          201: {
    ...
    '/daily-reports/{id}': {
      get: {
        ...
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        responses: {
          200: { description: 'Thông tin báo cáo', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/DailyReport' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
      ...
      put: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateDailyReportBody' } } } },
        responses: {
          200: { description: 'Cập nhật báo cáo thành công', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/DailyReport' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
    ...
    '/weekly-evaluations': {
      get: {
        ...
        parameters: [
          { in: 'query', name: 'internId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'leaderId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'week', schema: { type: 'integer' } },
          { $ref: '#/components/parameters/PageParam' },
          { $ref: '#/components/parameters/LimitParam' },
          { in: 'query', name: 'sortBy', schema: { type: 'string', enum: ['week', 'totalScore', 'createdAt'], default: 'createdAt' } },
          { $ref: '#/components/parameters/OrderParam' },
        ],
        responses: {
          200: {
            description: 'Danh sách đánh giá',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { type: 'array', items: { $ref: '#/components/schemas/WeeklyEvaluation' } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
        },
      ...
      post: {
        ...
        security: [{ BearerAuth: [] }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateWeeklyEvaluationBody' } } } },
        responses: {
          201: {
            description: 'Đã tạo đánh giá thành công',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/WeeklyEvaluation' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          409: { description: 'Đã tồn tại đánh giá cho tuần này', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
    },
    '/weekly-evaluations/{id}': {
      get: {
        ...
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        responses: {
          200: { description: 'Thông tin đánh giá', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/WeeklyEvaluation' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
      ...
      put: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateWeeklyEvaluationBody' } } } },
        responses: {
          200: { description: 'Cập nhật thành công', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/WeeklyEvaluation' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
    ...
    '/notification-logs': {
      get: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [
          { in: 'query', name: 'notificationId', schema: { type: 'string', format: 'uuid' } },
          { in: 'query', name: 'channel', schema: { type: 'string', enum: ['WEB', 'EMAIL', 'DISCORD'] } },
          { in: 'query', name: 'status', schema: { type: 'string', enum: ['SUCCESS', 'FAILED'] } },
          { $ref: '#/components/parameters/PageParam' },
          { $ref: '#/components/parameters/LimitParam' },
          { in: 'query', name: 'sortBy', schema: { type: 'string', enum: ['sentAt'], default: 'sentAt' } },
          { $ref: '#/components/parameters/OrderParam' },
        ],
        responses: {
          200: {
            description: 'Danh sách nhật ký',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { type: 'array', items: { $ref: '#/components/schemas/NotificationLog' } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
        },
      ...
      post: {
        ...
        security: [{ BearerAuth: [] }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateNotificationLogBody' } } } },
        responses: {
          201: {
            description: 'Đã tạo nhật ký thành công',
            content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/NotificationLog' } } }] } } },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
    ...
    '/notification-logs/{id}': {
      get: {
        ...
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        responses: {
          200: { description: 'Thông tin nhật ký', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/NotificationLog' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
      ...
      put: {
        ...
        security: [{ BearerAuth: [] }],
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string', format: 'uuid' } }],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateNotificationLogBody' } } } },
        responses: {
          200: { description: 'Cập nhật thành công', content: { 'application/json': { schema: { allOf: [{ $ref: '#/components/schemas/SuccessResponse' }, { type: 'object', properties: { data: { $ref: '#/components/schemas/NotificationLog' } } }] } } } },
          401: { $ref: '#/components/responses/Unauthorized' },
          403: { $ref: '#/components/responses/Forbidden' },
          404: { $ref: '#/components/responses/NotFound' },
        },
